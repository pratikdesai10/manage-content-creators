  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Fill in your personal details to create your creator account.</p>
      </div>
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-gray-400">We'll send a verification link</p>
