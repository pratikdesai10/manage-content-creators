...
export function AccountManagerStep({ form }: AccountManagerStepProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Who's managing this account?</h2>
        <p className="text-gray-500 mt-1">We need details of the person handling brand collaborations</p>
      </div>
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-gray-400">Use your company email for faster verification</p>
        {errors.workEmail && <p className="mt-1 text-sm text-red-500">{errors.workEmail.message}</p>}
      </div>
      ...
      <div>
        ...
        <input
          ...
          className={inputClass}
        />
        <p className="mt-1 text-xs text-gray-400">Helps creators trust your brand</p>
